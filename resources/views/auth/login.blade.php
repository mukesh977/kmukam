...
<head>
  ...
  <title>Khabar Mukam | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url('/') }}"><b>Khabar</b>Mukam</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to start your session. If you face difficulty in login then press <b>Ctrl+Shift+Del</b> and clear browser data.</p>
...
<!-- AdminLTE App -->
<script src="{{ asset('backend/layout/dist/js/adminlte.min.js') }}"></script>
