...
@section('title', 'Khabarmukam | Page Create')
...
@section('content')
	<form role="form" method="post" action="{{ route('backend.page.store') }}" enctype="multipart/form-data">
		<div class="row">
			@csrf
	    <!-- left column -->
	    <div class="col-md-12">
	      ...
	      <div class="card card-primary">
            ...
            <div class="card-tools" style="display: flex;">
              <div style="margin-right: 30px;">
                <a href="{{ url('/admin/page') }}" class="btn btn-success btn-xs" title="List Feature">List Page</a>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="linkName" value="{{ old('linkName') }}">
        ...
        <div class="card card-primary collapsed-card">
          ...
          <div class="card-body" style="display: none;">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="seoDescription">{{ old('seoDescription') }}</textarea>
