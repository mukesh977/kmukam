...
@section('content-header')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Add Team Category</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Add Team Category</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
@section('content')
  <form class="form-horizontal" method="post" action="{{ url('/admin/team/category') }}">
  {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              @endif
					...
					<div class="card-footer">
						<a href="{{ url('/admin/adventure/category') }}" class="btn btn-secondary btn-sm">Cancel</a>
						<input type="submit" value="Add" class="btn btn-success btn-sm float-right">
					</div>
        </div>
        <!-- /.card -->
      </div>
