    ...
    <div class="modal-content">
      <div class="modal-header">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"
          ...
          <input type="hidden" id="image" value="{{ old('image') }}" name="mediaImage">
        </ul>
      ...
      <div class="modal-body" id="gallery-image">
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" style="max-height: 70vh; overflow-y: scroll;">
            ...
            <div class="row">
              <div class="col-md-12">
                <input type="text" class="form-control" name="keywords" id="keywords" onkeyup="searchImage()" placeholder="Search">
              </div>
