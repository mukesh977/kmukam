...
@section('title', 'News Detail advertisement')
...
@section('content-header')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>News Detail Advertisement</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">News Detail Advertisement</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
@section('content')
  <form class="form-horizontal" method="post" action="{{ route('backend.news-detail-advertisement.update', $editNewsAd->id) }}" enctype="multipart/form-data">
    @csrf
    @method('patch')
            ...
            <div class="row">
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" placeholder="Title" value="{{ !empty($editNewsAd)? $editNewsAd->title : '' }}">
              ...
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Position" value="{{ !empty($editNewsAd)? $editNewsAd->position : '' }}" disabled>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="link1" placeholder="Link 1" value="{{ !empty($editNewsAd)? $editNewsAd->link : '' }}">
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="date" class="form-control" name="publishDate1" placeholder="Publish Date 1" value="{{ !empty($editNewsAd->publish_date)? date('Y-m-d', strtotime($editNewsAd->publish_date)) : '' }}">
                    </div>
                    <div class="col-md-6">
                      <input type="time" class="form-control" name="publishTime1" placeholder="Publish Time 1" value="{{ !empty($editNewsAd->publish_date)? date('H:i:s', strtotime($editNewsAd->publish_date)) : '' }}">
                    </div>
                  </div>
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="date" class="form-control" name="endDate1" placeholder="End Date 1" value="{{ !empty($editNewsAd->end_date)? date('Y-m-d', strtotime($editNewsAd->end_date)) : '' }}">
                    </div>
                    <div class="col-md-6">
                      <input type="time" class="form-control" name="endTime1" placeholder="End Time 1" value="{{ !empty($editNewsAd->end_date)? date('H:i:s', strtotime($editNewsAd->end_date)) : '' }}">
                    </div>
                  </div>
              ...
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <select class="form-control" name="status1">
                    ...
                    <option value="1" {{ !is_null($editNewsAd)? (($editNewsAd->status==1)? 'selected' : '') : '' }}>Active</option>
                    <option value="0" {{ !is_null($editNewsAd)? (($editNewsAd->status==0)? 'selected' : '') : '' }}>Inactive</option>
                  </select>
              ...
              <div class="col-md-12">
                <div class="col-md-12 pl-0" id="media_image_preview" style="margin-top: 10px;">
                  <img src="{{ !empty($editNewsAd->image)? asset('images/advertisement/'. $editNewsAd->image) : '' }}" width="100%">
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="link2" placeholder="Link 2" value="{{ !empty($editNewsAd)? $editNewsAd->link_2 : '' }}">
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <input type="date" class="form-control" name="publishDate2" placeholder="Publish Date 2" value="{{ !empty($editNewsAd->publish_date_2)? date('Y-m-d', strtotime($editNewsAd->publish_date_2)) : '' }}">
                      </div>
                      <div class="col-md-6">
                        <input type="time" class="form-control" name="publishTime2" placeholder="Publish Time 2" value="{{ !empty($editNewsAd->publish_date_2)? date('H:i:s', strtotime($editNewsAd->publish_date_2)) : '' }}">
                      </div>
                    </div>
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <input type="date" class="form-control" name="endDate2" placeholder="End Date 2" value="{{ !empty($editNewsAd->end_date_2)? date('Y-m-d', strtotime($editNewsAd->end_date_2)) : '' }}">
                      </div>
                      <div class="col-md-6">
                        <input type="time" class="form-control" name="endTime2" placeholder="End Time 2" value="{{ !empty($editNewsAd->end_date_2)? date('H:i:s', strtotime($editNewsAd->end_date_2)) : '' }}">
                      </div>
                    </div>
                ...
                <div class="col-md-6 mb-10">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status2">
                      <option value="">Select Status</option>
                      <option value="1" {{ !is_null($editNewsAd)? (($editNewsAd->status_2==1)? 'selected' : '') : '' }}>Active</option>
                      <option value="0" {{ !is_null($editNewsAd)? (($editNewsAd->status_2==0)? 'selected' : '') : '' }}>Inactive</option>
                    </select>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 pl-0" id="media_image_preview2" style="margin-top: 10px;">
                    <img src="{{ !empty($editNewsAd->image_2)? asset('images/advertisement/'. $editNewsAd->image_2) : '' }}" width="100%">
                  </div>
