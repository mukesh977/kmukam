...
@section('title', 'List News Detail advertisement')
		...
		<div class="col-md-12">
			<div class="card card-primary">
				<div class="card-header">
					<h3 class="card-title"><strong>List News Detail Advertisement</strong></h3>
				</div>
				<!-- /.box-header -->
...
@section('after-script')
	...
	<script>
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('backend.news-detail-advertisement.index') }}",
        columns: [
          { data: 'DT_RowIndex' },
			...
			$("body").on('click', '.delete', function (e){
				...
				.then((willDelete) => {
					...
					if (willDelete) {
						...
						$.ajax({
							type: "delete",
							url: url +'/admin/news-detail-advertisement/'+ deleteId,
							data: data,
