...
@section('title', 'List home advertisement')
		...
		<div class="col-md-12">
			<div class="card card-primary">
				<div class="card-header">
					<h3 class="card-title"><strong>List Home Advertisement</strong></h3>
				</div>
				<!-- /.box-header -->
...
@section('after-script')
	...
	<script>
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('backend.home-advertisement.index') }}",
        columns: [
          { data: 'DT_RowIndex' },
			...
			$("body").on('click', '.delete', function (e){
				...
				.then((willDelete) => {
					...
					if (willDelete) {
						...
						$.ajax({
							type: "delete",
							url: url +'/admin/home-advertisement/'+ deleteId,
							data: data,
