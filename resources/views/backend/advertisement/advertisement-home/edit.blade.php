...
@section('title', 'Edit home advertisement')
...
@section('content-header')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Edit Home Advertisement</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Edit Home Advertisement</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
@section('content')
  <form class="form-horizontal" method="post" action="{{ route('backend.home-advertisement.update', $editHomeAd->id) }}" enctype="multipart/form-data">
    @csrf
    @method('patch')
            ...
            <div class="row">
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" placeholder="Title" value="{{ !empty($editHomeAd)? $editHomeAd->title : '' }}">
              ...
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Position" value="{{ !empty($editHomeAd)? $editHomeAd->position : '' }}" disabled>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="link1" placeholder="Link 1" value="{{ !empty($editHomeAd)? $editHomeAd->link : '' }}">
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="date" class="form-control" name="publishDate1" placeholder="Publish Date 1" value="{{ !empty($editHomeAd->publish_date)? date('Y-m-d', strtotime($editHomeAd->publish_date)) : '' }}">
                    </div>
                    <div class="col-md-6">
                      <input type="time" class="form-control" name="publishTime1" placeholder="Publish Time 1" value="{{ !empty($editHomeAd->publish_date)? date('H:i:s', strtotime($editHomeAd->publish_date)) : '' }}">
                    </div>
                  </div>
              ...
              <div class="col-md-4 mb-10">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="date" class="form-control" name="endDate1" placeholder="End Date 1" value="{{ !empty($editHomeAd->end_date)? date('Y-m-d', strtotime($editHomeAd->end_date)) : '' }}">
                    </div>
                    <div class="col-md-6">
                      <input type="time" class="form-control" name="endTime1" placeholder="End Time 1" value="{{ !empty($editHomeAd->end_date)? date('H:i:s', strtotime($editHomeAd->end_date)) : '' }}">
                    </div>
                  </div>
              ...
              <div class="col-md-6 mb-10">
                <div class="form-group">
                  ...
                  <select class="form-control" name="status1">
                    ...
                    <option value="1" {{ !is_null($editHomeAd)? (($editHomeAd->status==1)? 'selected' : '') : '' }}>Active</option>
                    <option value="0" {{ !is_null($editHomeAd)? (($editHomeAd->status==0)? 'selected' : '') : '' }}>Inactive</option>
                  </select>
              ...
              <div class="col-md-12">
                <div class="col-md-12 pl-0" id="media_image_preview" style="margin-top: 10px;">
                  <img src="{{ !empty($editHomeAd->image)? asset('images/advertisement/'. $editHomeAd->image) : '' }}" width="100%">
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="link2" placeholder="Link 2" value="{{ !empty($editHomeAd)? $editHomeAd->link_2 : '' }}">
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <input type="date" class="form-control" name="publishDate2" placeholder="Publish Date 2" value="{{ !empty($editHomeAd->publish_date_2)? date('Y-m-d', strtotime($editHomeAd->publish_date_2)) : '' }}">
                      </div>
                      <div class="col-md-6">
                        <input type="time" class="form-control" name="publishTime2" placeholder="Publish Time 2" value="{{ !empty($editHomeAd->publish_date_2)? date('H:i:s', strtotime($editHomeAd->publish_date_2)) : '' }}">
                      </div>
                    </div>
                ...
                <div class="col-md-4 mb-10">
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <input type="date" class="form-control" name="endDate2" placeholder="End Date 2" value="{{ !empty($editHomeAd->end_date_2)? date('Y-m-d', strtotime($editHomeAd->end_date_2)) : '' }}">
                      </div>
                      <div class="col-md-6">
                        <input type="time" class="form-control" name="endTime2" placeholder="End Time 2" value="{{ !empty($editHomeAd->end_date_2)? date('H:i:s', strtotime($editHomeAd->end_date_2)) : '' }}">
                      </div>
                    </div>
                ...
                <div class="col-md-6 mb-10">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status2">
                      <option value="">Select Status</option>
                      <option value="1" {{ !is_null($editHomeAd)? (($editHomeAd->status_2==1)? 'selected' : '') : '' }}>Active</option>
                      <option value="0" {{ !is_null($editHomeAd)? (($editHomeAd->status_2==0)? 'selected' : '') : '' }}>Inactive</option>
                    </select>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 pl-0" id="media_image_preview2" style="margin-top: 10px;">
                    <img src="{{ !empty($editHomeAd->image_2)? asset('images/advertisement/'. $editHomeAd->image_2) : '' }}" width="100%">
                  </div>
