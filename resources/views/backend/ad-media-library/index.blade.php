...
@section('title', 'Ad Media Library')
...
@section('content')
    <form action="{{ route('backend.ad-media-library.bulk-delete') }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('delete')
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools" style="display: flex;">
                            <div style="margin-right: 10px;">
                                <a href="{{ route('backend.ad-media-library.create') }}" class="btn btn-success btn-xs mx-2">Add</a>
