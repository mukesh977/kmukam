...
<section class="main-pradesh sec-padding">
  <div class="container-fluid">
      <div class="sec-title">
          <h4>स्थानीय निकाय </h4>
          <span><a href="{{ route('frontend.category', 'local-governance') }}">सबै </a></span>
      </div>
              ...
              <div class="col-lg-2">
                  <div class="mpt-left">
                      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                          ...
                          @foreach ($localGovernance->subCategories as $index1 => $subCategory)
                              <li class="nav-item">
                                  <a class="nav-link {{ ($index1==0)? 'active' : '' }}" id="pillsContent-{{ $index1 + 1 }}-tab" data-toggle="pill" href="#pillsContent-{{ $index1 + 1 }}"
                                      role="tab" aria-controls="pillsContent-{{ $index1 + 1 }}" aria-selected="{{ ($index1==0)? 'true' : 'false' }}">{{ $subCategory->title_np }} </a>
                              </li>
                          @endforeach
              ...
              <div class="col-lg-10">
                  <div class="mpt-right">
                      <div class="tab-content" id="pills-tabContent">
                          ...
                          @foreach ($localGovernance->subCategories as $index2 => $subCategory)
                              <div class="tab-pane fade {{ ($index2==0)? 'active show' : '' }}" id="pillsContent-{{ $index2 + 1 }}" role="tabpanel"
                                  aria-labelledby="pillsContent-{{ $index2 + 1 }}-tab">
                                  <div class="row">
                                      <div class="col-lg-8">
